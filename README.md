...
Минимальная версия Android — API 24 (Android 7.0). Доступность shell-действий через Shizuku зависит от версии Android и прошивки производителя. Приложение не требует root и не выполняет необратимых низкоуровневых изменений.
